 ...
 * Await subcommand
 */
Transaction.prototype.do_await = function(subcmd, opts, args, cb) {
    (async () => {
        // Transcation id
        let transactionId;
        if (opts.id) {
            ...
            transactionId = await helper.read(opts.id_file);
        } else {
 ...
 * Status subcommand
 */
Transaction.prototype.do_status = function(subcmd, opts, args, cb) {
    (async () => {
        // Transcation id
        let transactionId;
        if (opts.id) {
