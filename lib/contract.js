 ...
 * List subcommand
 */
Contract.prototype.do_list = function(subcmd, opts, args, cb) {
    (async () => {
 ...
 * Execute subcommand
 */
Contract.prototype.do_execute = function(subcmd, opts, args, cb) {
    (async () => {
        // Signing key
        let signingKey;
        if (opts.signing_key) {
            signingKey = opts.signing_key;
                ...
                signingKey = await helper.read(opts.signing_keyfile);
        } else {
        ...
        if (opts.payload) {
            ...
            payload = await helper.read(opts.payload_file);
        } else {
 ...
 * Create subcommand
 */
Contract.prototype.do_create = function(subcmd, opts, args, cb) {
 ...
 * Delete subcommand
 */
Contract.prototype.do_delete = function(subcmd, opts, args, cb) {
    (async () => {
        // Get contracts from client
        const client = await this.getClient(opts);
